...
from helper import admin_locators as locate
...
def user_role_page(page: Page):
    ...
    return actions_for_pages.get_text_action(page, locate.user_role_text_selector)
...
def search_invalid_username_page(page: Page):
    ...
    actions_for_pages.click_action(page, locate.submit_button_selector)
    return actions_for_pages.get_text_action(page, locate.no_records_found_selector)