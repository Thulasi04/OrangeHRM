...
from helper import pim_locators as locate
...
def navigate_to_pim(page: Page):
    ...
    return actions_for_pages.get_text_action(page, locate.pim_header_selector)
...
def navigate_to_add_employee(page: Page):
    ...
    return actions_for_pages.get_text_action(page, locate.add_employee_header_selector)
